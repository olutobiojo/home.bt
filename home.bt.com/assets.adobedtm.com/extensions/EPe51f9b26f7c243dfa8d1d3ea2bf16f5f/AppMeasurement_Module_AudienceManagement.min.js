// For license information, see `https://assets.adobedtm.com/extensions/EPe51f9b26f7c243dfa8d1d3ea2bf16f5f/AppMeasurement_Module_AudienceManagement.js`.
function AppMeasurement_Module_AudienceManagement(e) {
    ...
    "function" != typeof window.DIL && (window.DIL = function(e) {
        ...
        var E = {
                ...
                logMemo: {},
                log: function(e) {
                    S.push(e), m && this.doesConsoleLogExist && Function.prototype.bind.call(window.console.log, window.console).apply(window.console, arguments)
                },
                logOnce: function(e) {
            ...
            P = {
                IS_HTTPS: p || "https:" === document.location.protocol,
        ...
        P.IS_IE_LESS_THAN_10 = "number" == typeof P.IE_VERSION && P.IE_VERSION < 10;
        var L = {
                stuffed: {}
            },
            A = {},
                ...
                adms: {
                    ...
                    process: function(e) {
                        try {
                            ...
                            if (!O) throw new Error("Error in processing Visitor API, which is a hard dependency for DIL v8.0+: " + e.message);
                    ...
                    waitForMidToReleaseRequests: function() {
                        ...
                        }), !0), (!F.exists || !F.isIabContext && F.isApproved() || F.isIabContext && G.hasGoSignal()) && setTimeout((function() {
                    ...
                    getCustomerIDsQueryString: function(e) {
                        ...
                        if (i = o.length)
                            for (s = 0; s < i; s++) r += "&d_cid_ic=" + N.encodeAndBuildRequest(o[s], "%01");
                        return r
                    },
                    ...
                    isOptedOutCallback: function(e) {
                        this.isOptedOut = e, this.isOptedOutCallbackCalled = !0, q.registerRequest(), F.isIabContext() && G.checkQueryStringObject()
                    },
                ...
                declaredId: {
                    ...
                    getDeclaredIdQueryString: function() {
                        var e = this.declaredId.request,
                            ...
                            s = "";
                        return null !== e ? s = "&d_dpid=" + n(e.dpid) + "&d_dpuuid=" + n(e.dpuuid) : null !== t && (s = "&d_dpid=" + n(t.dpid) + "&d_dpuuid=" + n(t.dpuuid)), s
                    }
                },
                registerRequest: function(e) {
                    var t, n = this.firingQueue;
                    e === Object(e) && (n.push(e), e.isDefaultRequest || (b = !0)), this.firing || !n.length || f && !DIL.windowLoaded || (this.adms.isOptedOutCallbackCalled || this.adms.getIsOptedOut(), this.adms.calledBack && !this.adms.isOptedOut && this.adms.isOptedOutCallbackCalled && (F.isApproved() || G.hasGoSignal()) && (this.adms.isOptedOutCallbackCalled = !1, (t = n.shift()).src = t.src.replace(/&d_nsid=/, "&" + this.adms.getMIDQueryString() + G.getQueryString() + "d_nsid="), x.isPopulatedString(t.corsPostData) && (t.corsPostData = t.corsPostData.replace(/^d_nsid=/, this.adms.getMIDQueryString() + G.getQueryString() + "d_nsid=")), k.fireRequest(t), this.firstRequestHasFired || "script" !== t.tag && "cors" !== t.tag || (this.firstRequestHasFired = !0)))
                },
                processVisitorAPI: function() {
                    this.adms.process(D || window.Visitor)
                },
        ...
        var j, T, M = {
                ...
                requestToProcess: function(e, t) {
                    ...
                    var s, i = this;
                    if (e && !x.isEmptyObject(e))
                        if (s = JSON.stringify(e.dests || []), this.jsonForComparison.length) {
                            var r, o, a, d = !1;
                            for (r = 0, o = this.jsonForComparison.length; r < o; r++)
                                if (a = this.jsonForComparison[r], s === JSON.stringify(a.dests || [])) {
                                    d = !0;
                                    break
                                }
                            d ? this.jsonDuplicates.push(e) : n()
                        } else n();
                    ...
                    if (I) {
                        ...
                        if (-1 !== d) {
                            if ((t = e.dests) && t instanceof Array && (n = t.length)) {
                                ...
                                1 === d && u && E.logOnce("Warning: visitorInstance.publishDestinations version is old (Visitor v3.3.0 to v4.0.0). URL destinations will not have the option of being fired on page, only in the iframe.")
                            }
                ...
                sendMessages: function() {
                    this.sendingMessages || (this.sendingMessages = !0, I && this.messages.length && this.publishDestinations())
                },
                publishDestinations: function() {
                    ...
                    var n = this,
                        ...
                        i = [],
                        o = [];
                    return 1 === this.publishDestinationsVersion ? (N.extendArray(i, this.messages), N.extendArray(this.messagesPosted, this.messages), t(), s.publishDestinations(r, i, e), "Called visitor.publishDestinations() version 1") : 1 < this.publishDestinationsVersion ? (N.extendArray(o, this.destinations), N.extendArray(this.destinationsPosted, this.destinations), t(), s.publishDestinations({
                        subdomain: r,
                        callback: e,
                        urlDestinations: o
            ...
            V = {
                traits: function(e) {
                    return x.isValidPdata(e) && (A.sids instanceof Array || (A.sids = []), N.extendArray(A.sids, e)), this
                },
                pixels: function(e) {
                    return x.isValidPdata(e) && (A.pdata instanceof Array || (A.pdata = []), N.extendArray(A.pdata, e)), this
                },
                logs: function(e) {
                    return x.isValidLogdata(e) && (A.logdata !== Object(A.logdata) && (A.logdata = {}), N.extendObject(A.logdata, e)), this
                },
                customQueryParams: function(e) {
                    return x.isEmptyObject(e) || N.extendObject(A, e, q.reservedKeys), this
                },
                signals: function(e, t) {
                    ...
                    if (!x.isEmptyObject(s)) {
                        ...
                        N.extendObject(A, s, q.reservedKeys)
                    }
                    return this
                },
                ...
                result: function(e) {
                    return "function" == typeof e && (A.callback = e), this
                },
                afterResult: function(e) {
                    return "function" == typeof e && (A.postCallbackFn = e), this
                },
                useImageRequest: function() {
                    return A.useImageRequest = !0, this
                },
                clearData: function() {
                    return A = {}, this
                },
                submit: function(e) {
                    return A.isDefaultRequest = !!e, k.submitRequest(A), A = {}, this
                },
                getPartner: function() {
                    return r
                },
                ...
                passData: function(e) {
                    return x.isEmptyObject(e) ? "Error: json is empty or not an object" : (k.defaultCallback(e), e)
                },
            ...
            k = {
                corsMetadata: (j = "none", "undefined" != typeof XMLHttpRequest && XMLHttpRequest === Object(XMLHttpRequest) && "withCredentials" in new XMLHttpRequest && (j = "XMLHttpRequest"), {
                    corsType: j
                }),
                ...
                submitRequest: function(e) {
                    return q.registerRequest(k.createQueuedRequest(e)), !0
                },
                createQueuedRequest: function(e) {
                    var t, n, s, i, r, o = e.callback,
                        d = "img",
                        u = e.isDefaultRequest;
                    if (delete e.isDefaultRequest, !x.isEmptyObject(a))
                        for (s in a)
                            if (a.hasOwnProperty(s)) {
                                if (null == (i = a[s]) || "" === i) continue;
                                if (s in e && !(i in e) && !(i in q.reservedKeys)) {
                                    if (null == (r = e[s]) || "" === r) continue;
                                    e[i] = r
                                }
                            }
                    return x.isValidPdata(e.sids) || (e.sids = []), x.isValidPdata(e.pdata) || (e.pdata = []), x.isValidLogdata(e.logdata) || (e.logdata = {}), e.logdataArray = N.convertObjectToKeyValuePairs(e.logdata, "=", !0), e.logdataArray.push("_ts=" + (new Date).getTime()), "function" != typeof o && (o = this.defaultCallback), t = this.makeRequestSrcData(e), (n = this.getCORSInstance()) && !0 !== e.useImageRequest && (d = "cors"), {
                        tag: d,
                        src: t.src,
                        corsSrc: t.corsSrc,
                        callbackFn: o,
                ...
                defaultCallback: function(e, t) {
                    var n, s, i, r, o, a, u, c, l;
                    if (y && (n = e.stuff) && n instanceof Array && (s = n.length))
                        for (i = 0; i < s; i++)(r = n[i]) && r === Object(r) && (o = r.cn, a = r.cv, void 0 !== (u = r.ttl) && "" !== u || (u = Math.floor(N.getMaxCookieExpiresInMinutes() / 60 / 24)), c = r.dmn || "." + document.domain.replace(/^www\./, ""), l = r.type, o && (a || "number" == typeof a) && ("var" !== l && (u = parseInt(u, 10)) && !isNaN(u) && N.setCookie(o, a, 24 * u * 60, "/", c, !1), L.stuffed[o] = a));
                    var f, p, h = e.uuid;
                    x.isPopulatedString(h) && (x.isEmptyObject(d) || ("string" == typeof(f = d.path) && f.length || (f = "/"), p = parseInt(d.days, 10), isNaN(p) && (p = 100), N.setCookie(d.name || "aam_did", h, 24 * p * 60, f, d.domain || "." + document.domain.replace(/^www\./, ""), !0 === d.secure))), q.abortRequests || M.requestToProcess(e, t)
                },
                makeRequestSrcData: function(e) {
                    e.sids = x.removeEmptyArrayValues(e.sids || []), e.pdata = x.removeEmptyArrayValues(e.pdata || []);
                    var t = q,
                        n = t.platformParams,
                        s = N.encodeAndBuildRequest(e.sids, ","),
                        i = N.encodeAndBuildRequest(e.pdata, ","),
                        o = (e.logdataArray || []).join("&");
                    delete e.logdataArray;
                    var a, d, u = encodeURIComponent,
                        c = P.IS_HTTPS ? "https://" : "http://",
                        ...
                        p = function() {
                            ...
                            for (n in e)
                                if (!(n in t.reservedKeys) && e.hasOwnProperty(n))
                                    if (s = e[n], n = u(n), s instanceof Array)
                                        for (i = 0, r = s.length; i < r; i++) o.push(n + "=" + u(s[i]));
                                    else o.push(n + "=" + u(s));
                            return o.length ? "&" + o.join("&") : ""
                        }(),
                        h = "d_dil_ver=" + u(DIL.version),
                        m = "d_nsid=" + n.d_nsid + t.getCoopQueryString() + l + f + (s.length ? "&d_sid=" + s : "") + (i.length ? "&d_px=" + i : "") + (o.length ? "&d_ld=" + u(o) : ""),
                        I = "&d_rtbd=" + n.d_rtbd + "&d_jsonv=" + n.d_jsonv + "&d_dst=" + n.d_dst,
                        y = g ? "&h_referer=" + u(location.href) : "";
                    return d = (a = c + r + ".demdex.net/event") + "?" + h + "&" + m + I + p + y, {
                        corsSrc: a + "?" + h + "&_ts=" + (new Date).getTime(),
                        src: d,
                        corsPostData: m + I + p + y,
                        isDeclaredIdCall: "" !== l
                    }
                },
                ...
                fireImage: function(e) {
                    var t, n, i = q;
                    i.abortRequests || (i.firing = !0, t = new Image(0, 0), i.sent.push(e), t.onload = function() {
                        i.firing = !1, i.fired.push(e), i.num_of_img_responses++, i.registerRequest()
                    }, n = function(t) {
                        s = "imgAbortOrErrorHandler received the event of type " + t.type, E.log(s), i.abortRequests = !0, i.firing = !1, i.errored.push(e), i.num_of_img_errors++, i.registerRequest()
                ...
                fireCORS: function(e, t) {
                    var n = this,
                        ...
                        c = e.postCallbackFn,
                        l = "function" == typeof c;
                    if (!i.abortRequests && !C) {
                        i.firing = !0;
                        try {
                            d.open("post", a, !0), "XMLHttpRequest" === o && (d.withCredentials = !0, d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), d.onreadystatechange = function() {
                                4 === this.readyState && 200 === this.status && function(o) {
                                    var a;
                                    try {
                                        if ((a = JSON.parse(o)) !== Object(a)) return n.handleCORSError(e, t, "Response is not JSON")
                                    } catch (o) {
                                        return n.handleCORSError(e, t, "Error parsing response as JSON")
                                    }
                                    try {
                                        var d = e.callbackFn;
                                        i.firing = !1, i.fired.push(e), i.num_of_cors_responses++, d(a, t), l && c(a, t)
                                    } catch (o) {
                                        o.message = "DIL handleCORSResponse caught error with message " + o.message, s = o.message, E.log(s), o.filename = o.filename || "dil.js", o.partner = r, DIL.errorModule.handleError(o);
                                        try {
                                            d({
                ...
                handleCORSError: function(e, t, n) {
                    q.num_of_cors_errors++, q.corsErrorSources.push(n)
                }
            },
            x = {
            ...
            N = {
                convertObjectToKeyValuePairs: function(e, t, n) {
                    var s, i, r = [];
                    for (s in t = t || "=", e) e.hasOwnProperty(s) && null != (i = e[s]) && "" !== i && r.push(s + t + (n ? encodeURIComponent(i) : i));
                    return r
                },
                ...
                setCookie: function(e, t, n, s, i, r) {
                    var o = new Date;
                    n = n && 1e3 * n * 60, document.cookie = e + "=" + encodeURIComponent(t) + (n ? ";expires=" + new Date(o.getTime() + n).toUTCString() : "") + (s ? ";path=" + s : "") + (i ? ";domain=" + i : "") + (r ? ";secure" : "")
                },
                ...
                extendObject: function(e, t, n) {
                    ...
                    for (s in t)
                        if (t.hasOwnProperty(s)) {
                            if (!x.isEmptyObject(n) && s in n) continue;
                            e[s] = t[s]
                        }
                    return !0
                },
                getMaxCookieExpiresInMinutes: function() {
                    return P.SIX_MONTHS_IN_MINUTES
                },
            ...
            F = (T = _.requestController, {
                ...
                callback: function() {
                    this.aamIsApproved = this.instance.isApproved([this.instance.Categories.AAM]), T.adms.waitForMidToReleaseRequests(), T.adms.getIsOptedOut()
                },
                isApproved: function() {
                    return !this.isIabContext() && !T.adms.isOptedOut && (!this.exists || this.aamIsApproved)
                },
        ...
        _.optIn = F;
        var Q, H, U, B, G = (H = (Q = _).requestController, U = Q.optIn, B = {
            ...
            hasGoSignal: function() {
                return !(!(U.isIabContext() && this.isVendorConsented && this.doesGdprApply && "string" == typeof this.consentString && this.consentString.length) || H.adms.isOptedOut)
            },
            fetchConsentData: function(e, t) {
                var n = this,
                    s = {};
                "function" != typeof e && (e = function() {}), U.instance && U.isIabContext() ? (t && (s.timeout = t), U.instance.execute({
                    command: "iabPlugin.fetchConsentData",
                    params: s,
                    callback: function(t, s) {
                        s === Object(s) ? (n.doesGdprApply = !!s.gdprApplies, n.consentString = s.consentString || "") : (n.doesGdprApply = !1, n.consentString = ""), n.isVendorConsented = U.instance.isApproved(U.instance.Categories.AAM), t ? e({}) : n.checkQueryStringObject(e), H.adms.waitForMidToReleaseRequests()
                    }
                })) : e({})
            },
            getQueryString: function() {
                return U.isIabContext() ? "gdpr=" + (this.doesGdprApply ? 1 : 0) + "&gdpr_consent=" + this.consentString + "&" : ""
            },
            getQueryStringObject: function(e, t) {
                this.fetchConsentData(e, t)
            },
            checkQueryStringObject: function(e) {
                B.hasGoSignal() && "function" == typeof e && e({
                    gdpr: this.doesGdprApply ? 1 : 0,
                    gdpr_consent: this.consentString
                })
            }
        });
        _.iab = G, "error" === r && 0 === o && window.addEventListener("load", (function() {
            DIL.windowLoaded = !0
        }));
        var W = !1,
            X = function() {
                setTimeout((function() {
                    b || q.firstRequestHasFired || ("function" == typeof v ? V.afterResult(v).submit(!0) : V.submit(!0))
                }), DIL.constants.TIME_TO_DEFAULT_REQUEST)
            },
            K = document;
        "error" !== r && (DIL.windowLoaded ? n() : "complete" !== K.readyState && "loaded" !== K.readyState ? window.addEventListener("load", (function() {
            DIL.windowLoaded = !0, n()
        })) : (DIL.windowLoaded = !0, n())), q.declaredId.setDeclaredId(l, "init"), F.init(), G.init(), q.processVisitorAPI(), P.IS_IE_LESS_THAN_10 && N.replaceMethodsWithFunction(V, (function() {
            return this
        })), this.api = V, this.getStuffedVariable = function(e) {
            var t = L.stuffed[e];
            return t || "number" == typeof t || (t = N.getCookie(e)) || "number" == typeof t || (t = ""), t
        }, this.validators = x, this.helpers = N, this.constants = P, this.log = S, this.pendingRequest = A, this.requestController = q, this.destinationPublishing = M, this.requestProcs = k, this.units = _, this.initConfig = e, this.logger = E, w && (this.variables = L, this.callWindowLoadFunctions = n)
        ...
        handleError: function(s) {
            ...
            s !== Object(s) && (s = {});
            var i = s.name ? (s.name + "").toLowerCase() : "",
                r = i in t ? t[i] : t.noerrortypedefined,
                o = [],
                a = {
                    name: i,
                    filename: s.filename ? s.filename + "" : "",
                    partner: s.partner ? s.partner + "" : "no_partner",
                    site: s.site ? s.site + "" : document.location.href,
                    message: s.message ? s.message + "" : ""
                };
            return o.push(r), e.api.pixels(o).logs(a).useImageRequest().submit(), "DIL error report sent"
        },
        pixelMap: t
