...
function AppMeasurement(e) {
    ...
    t.log = function(e) {
        ...
        var e;
        if (t.isReadyToTrack() && (t.Fb(), t.j != a))
            for (; 0 < t.j.length;)(e = t.j.shift()).Kb.apply(e.Lb, e.Ib)
    }, t.Fb = function() {
        ...
        if ("object" == typeof e)
            if (t.Pb(e), "object" == typeof t.AudienceManagement && "function" == typeof t.AudienceManagement.isReady && t.AudienceManagement.isReady() && "function" == typeof t.AudienceManagement.passData) t.AudienceManagement.passData(e);
        ...
        if (!t.o || (t.v && t.v.complete && t.v.C && t.v.R(), !t.o))
            if (t.Qa = a, t.oa) t.ja > t.N && t.Xa(t.i), t.ra(500);
            else {
                var e = t.Jb();
    ...
    for (o && "y" == o.x ? (t.X = !0, t.W = function(e) {
            ...
            if (t.trackOffline)
                for ((!t.offlineLimit || 0 >= t.offlineLimit) && (t.offlineLimit = 10); t.i.length > t.offlineLimit;) t.Na()
                ...
                try {
                    if (!t.clickObject || t.M && t.M == t.clickObject || !(t.clickObject.tagName || t.clickObject.parentElement || t.clickObject.parentNode)) t.clickObject = 0;
                        ...
                        if (t.ia && (clearTimeout(t.ia), t.ia = 0), t.ia = setTimeout((function() {
                            ...
                            if (o && (c = o.href, t.Ra(c) || (c = 0),
                                    i = o.target, e.target.dispatchEvent && c && (!i || "_self" == i || "_top" == i || "_parent" == i || n.name && i == n.name))) {
                                try {
